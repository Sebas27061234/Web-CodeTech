<!DOCTYPE html>
<html lang="en" dir="ltr" data-bs-theme="light" data-color-theme="Code_Theme" data-layout="vertical">
...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <button class="btn btn-primary p-3 rounded-circle d-none align-items-center justify-content-center customizer-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
      ...
      <div class="offcanvas customizer offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body h-n80" data-simplebar>
          ...
          <div class="d-flex flex-row flex-wrap gap-3 customizer-box color-pallete" role="group">
            <input type="radio" class="btn-check" name="color-theme-layout" id="Code_Theme" autocomplete="off" />
            <label class="btn p-9 btn-outline-primary d-flex align-items-center justify-content-center" onclick="handleColorTheme('Code_Theme')" for="Code_Theme" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="CODE_THEME">
  ...
  <script src="{{ asset('admin/assets/js/dashboards/dashboard1.js') }}"></script>
  @yield('scripts')
</body>
</html>