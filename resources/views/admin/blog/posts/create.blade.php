...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">Nuevo Post</h4>
...
<div class="card">
  <div class="card-body">
    <h3 class="mb-3">Crear Post</h3>
    {{ html()->form('POST')->route('admin.blog.posts.store')->attributes(['enctype' => 'multipart/form-data','class'=>'row'])->open() }}
    <div class="col-md-6">
      <div class="mb-3">
