...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">Nuevo Producto</h4>
...
<div class="card">
  <div class="card-body">
    ...
    {{ html()->form('POST')->route('admin.tienda.productos.store')->attributes(['enctype' => 'multipart/form-data','class'=>'row'])->open() }}
    @if ($errors->any())
    ...
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Titulo del producto">
      </div>
    </div>
    <div class="col-md-6">
      <div class="mb-3">
        <label class="form-label" for="slug">Sku:</label>
        <input type="text" class="form-control" name="sku" id="sku" placeholder="SKU del producto">
      </div>
    </div>
    <div class="col-md-12">
      <div class="mb-3">
        <label for="descripcion" class="form-label">Descripción:</label>
        <textarea class="form-control editorTiny" name="descripcion" id="descripcion" rows="5"></textarea>
      </div>
    </div>
    <div class="col-md-12">
      <div class="mb-3">
        <label for="contenido" class="form-label">Contenido:</label>
        <textarea class="form-control editorTiny" name="contenido" id="contenido" rows="5"></textarea>
      </div>
    </div>
    <div class="col-md-6 d-flex flex-column">
      <div class="mb-2 d-flex flex-column">
        <label for="imagen" class="form-label">Imagen:</label>
        <img src="" alt="" id="imgPostSelected" style="max-width: 50%">
      </div>
      <div class="mb-3">
    ...
    <div class="col-md-4">
      <div class="mb-3">
        ...
        <input type="number" class="form-control" name="precio" id="precio" step="0.01" placeholder="0.00">
      </div>
    </div>
    <div class="col-md-4">
      <div class="mb-3">
    ...
    <div class="col-md-4">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="descripcion_imagenes" id="descripcion_imagenes" placeholder="Descripcion de Imagenes del Producto" />
      </div>
    </div>
    <div class="col-md-4">
      <div class="mb-3">
        <label for="demo" class="form-label">Demo:</label>
        <input type="url" class="form-control" name="demo" id="demo" placeholder="Demo del Producto" />
      </div>
    </div>
    <div class="col-md-4">
      <div class="mb-3">
