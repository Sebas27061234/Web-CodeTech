...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">Nuevo Curso</h4>
...
<div class="card">
  <div class="card-body">
    ...
    {{ html()->form('POST')->route('admin.cursos.cursos.store')->attributes(['enctype' => 'multipart/form-data','class'=>'row'])->open() }}
    @if ($errors->any())
    ...
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Titulo del post">
      </div>
    </div>
    <div class="col-md-6">
      <div class="mb-3">
        <label class="form-label" for="slug">Slug:</label>
        <input type="text" class="form-control" name="slug" id="slug" placeholder="Slug del post">
      </div>
    </div>
    <div class="col-md-12">
      <div class="mb-3">
        <label for="descripcion" class="form-label">Descripción:</label>
        <textarea class="form-control" name="descripcion" id="descripcion" rows="3" placeholder="Descripción del post"></textarea>
      </div>
    </div>
    <div class="col-md-12">
      <div class="mb-3">
    ...
    <div class="col-md-4">
      <div class="mb-3">
        ...
        <input type="number" class="form-control" name="precio" id="precio" placeholder="0.00" step="0.01">
      </div>
    </div>
    <div class="col-md-4">
